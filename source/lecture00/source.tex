...
\pause
\item \textbf{Высокопроизводительные языки} \(\Longrightarrow\) на них пишут операционные системы, драйверы, базы данных, текстовые редакторы, веб-серверы, мультимедиа-редакторы, видеоигры
\pause
